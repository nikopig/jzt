		...
		<div class="common-condition-box">
			<el-form :inline="true">
				...
				<el-form-item label="委托方">
					<el-input :disabled="true" v-model="filterCondition.Con_Name" placeholder="双击选择委托方" @dblclick.native="openDialog('consignor')">
						<i slot="suffix" class="el-icon-close" @click="deleteConsignor"></i>
					</el-input>
				</el-form-item>
				<el-form-item label="承运方">
					<el-input :disabled="true" v-model="filterCondition.Carrier_Name" placeholder="双击选择承运方" @dblclick.native="openDialog('carrier')">
						<i slot="suffix" class="el-icon-close" @click="deleteCarrier"></i>
					</el-input>
				</el-form-item>
