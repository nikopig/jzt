    ...
    <div class="common-condition-box">
      <el-form :inline="true">
        ...
        <el-form-item label="对账单位">
          <el-input :disabled="true" placeholder="双击带出对账单位" v-model="condition.SettleUp_Company_Name" @dblclick.native=" isVisible = true" suffix-icon="el-icon-close" :on-icon-click="deleteCon"></el-input>
        </el-form-item>
        <el-form-item>
