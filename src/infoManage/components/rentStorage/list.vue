		...
		<div class="common-condition-box">
			<el-form :inline="true" ref="filterForm">
				<el-form-item label="运营方">
					<el-input placeholder="双击选择运营方" v-model="filterCondition.Operator_Name" :disabled="true" @dblclick.native="openDialog('operator')">
						<i slot="suffix" class="el-icon-close" @click="deleteOperator"></i>
					</el-input>
				</el-form-item>
				<el-form-item label="委托方">
					<el-input placeholder="双击选择委托方" v-model="filterCondition.Con_Name" :disabled="true" @dblclick.native="openDialog('consignor')">
						<i slot="suffix" class="el-icon-close" @click="deleteConsignor"></i>
					</el-input>
				</el-form-item>
				<el-form-item label="物流中心">
					<el-input placeholder="双击选择物流中心" v-model="filterCondition.Ldc_Name" :disabled="true" @dblclick.native="openDialog('ldc')">
